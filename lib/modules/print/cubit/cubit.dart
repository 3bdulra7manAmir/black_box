              ...
              children: data.map((item) {
                return pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text('اللون: ${item.color}', style: pw.TextStyle(font: arabicFont)),
                    pw.Text('الرقم التسلسلي: ${item.serialNumber}', style: pw.TextStyle(font: englishFont)),
                    pw.Text('مكان التواجد: ${item.destnation}', style: pw.TextStyle(font: arabicFont)),
